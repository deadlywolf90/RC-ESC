...
void setup() 
{
  ...
  */
  ...
  // ESC_deadzone_deg = radToDeg(ESC_deadzone);
...
{    
  ...
  else if (mode == MODE_MENU)
  {
    ...
    if (true) /// this block used to refresh the lcd
    {
      if (menuLevel == 0)
      { 
    ...
    {    
      ...
      else if (numChangeSelector == numChangeSelectorMax)
      {
        *inputFloatAdress = floatToEdit;
    		...
    		/// This is for calculating ESC_deadzone to rad
    		radioDataOut0.ESC_deadzone = degToRad(ESC_deadzone_deg);
